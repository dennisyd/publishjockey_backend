...
const config = {
  ...
  frontendUrl: process.env.FRONTEND_URL || (process.env.NODE_ENV === 'production' ? 'https://www.publishjockey.com' : 'http://localhost:3000'),
  ...
  cors: {
    origin: process.env.NODE_ENV === 'production' 
      ? process.env.ALLOWED_ORIGINS?.split(',') || ['https://www.publishjockey.com', 'https://publishjockey.com']
...
// In production, email configuration is also required
